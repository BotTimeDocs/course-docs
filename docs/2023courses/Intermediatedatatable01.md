...
* 课程简介：知识点1--读取区域VS读取行/列数据（课程时长：5分钟）
* 学习目标：掌握 ★★★
* 难易程度：一般 ★★
* 讲义下载：文末进群-获取“讲义PPT”
...
#### (1)、读取区域：输出“ Datatable”变量类型(数据表)

<img width = '400'  src ="https://doria-encooacademyimages.oss-cn-shanghai.aliyuncs.com/2023/01/13/16736170070310.jpg"/>

<br><br>

#### (2)、读取行/列数据：输出“数组”变量类型 

<img width = '400'  src ="https://doria-encooacademyimages.oss-cn-shanghai.aliyuncs.com/2023/01/13/16736169941644.jpg"/>
